...
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_CODE;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_NAME;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_PHOTO_PATH;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_PRICE;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_QUANTITY;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_SUPPLIER;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.COLUMN_SUPPLIER_EMAIL;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.SQL_CREATE_ENTRY;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.SQL_DELETE_ENTRY;
import static com.timotiusoktorio.inventoryapp.data.ProductContract.ProductEntry.TABLE_NAME;
...
public class ProductDbHelper extends SQLiteOpenHelper {
    ...
    public static synchronized ProductDbHelper getInstance(Context context) {
        if (sDbHelperInstance == null) {
            sDbHelperInstance = new ProductDbHelper(context);
        }
