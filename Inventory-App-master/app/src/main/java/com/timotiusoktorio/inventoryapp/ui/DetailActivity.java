...
import com.timotiusoktorio.inventoryapp.ui.dialogs.ConfirmationDialogFragment;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateViewsWithProductData() {
        ...
        TextView productSupplierTextView = findViewById(R.id.product_supplier_text_view);
        ...
        productPriceTextView.setText(getString(R.string.string_format_product_price_details, mProduct.getPrice()));
